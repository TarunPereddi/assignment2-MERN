...
const Home = () => {
  ...
  const closeUpdatePost = () => {
    ...
    const handlelike = async (e,UserID, PostID)=> {
      ...
      if(e.target.classList.contains("likes")) {
        ...
        const response = await fetch(`${API_URL}/post/users/like`, {
      method: method,
      headers: {
        "Content-Type": "application/json",
        authtoken: token,
  ...
  const handleUpdateSubmit = async (e) => {
    ...
    const response = await fetch(`${API_URL}/post/UpdatePost`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        authtoken: token,
...
const deletePost =async (PostID) => {
    const response = await fetch(`${API_URL}/post/users/delete`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          authtoken: token,
  ...
  const handleCommentSubmit = async (e, UserID, PostID) => {
    ...
    const response = await fetch(`${API_URL}/post/users/comment`, {
      method: "PUT",
      headers: {
        "Content-Type": "application/json",
        authtoken: token,
